...
| D09-08 | Staff debe validar sin scanner obligatorio                      | Dashboard movil consume una intencion firmada y corta                                               | E2E con wallet de asistente y staff                  | UI demo lista; runtime pendiente    |
...
| D09-14 | Staff bloquea doble uso                                         | El programa impone consumo exactamente una vez                                                      | Prueba automatizada y simulacion humana              | Unit/E2E pasan; validator pendiente |
...
| D09-18 | Preparar demo reproducible                                      | Guion fijo de organizador, asistente y staff, con fallback grabado                                  | README, video y transacciones devnet                 | Demo local lista; devnet pendiente  |
